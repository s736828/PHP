...
//以公式算出目標值前需要執行的迴圈數
//再以公式算出每一圈應該要印出的奇數
//$limit=floor($n/2); //樓地板，無條件捨去
// $limit=ceil($n/2); //天花板，無條件進位
//印出奇數終級寫法，使用者只需改n變數↓
$n=21;
...
//質數（Prime number），是指除了1和該數自身外，無法被其他自然數整除的數
//質數判斷方法
$n=37;
 ...
 ******************************************************/
 ...
 // 題目:以for迴圈產生質數 3,5,7,11,13,17……97
 // 條件 $i為3~97要跑的數字(外圈)，$j為要除的數，也就是除了1和該數外，設定初始2~($i-1)的數字
